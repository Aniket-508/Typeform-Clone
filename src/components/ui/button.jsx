export default function Button({ btnText = 'OK', tick = false, action }) {
    return (
        <div className="flex items-center space-x-4">
            <button className="outline-none border-none bg-[#0077ff] font-bold px-4 py-2 text-base md:text-xl rounded-md flex items-center space-x-1 hover:brightness-110" onClick={action}>
                <span>{btnText}</span>
                {tick && <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="items-center space-x-1 hidden md:flex">
                ...
                <svg width="15px" height="15px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <g id="🔍-System-Icons" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                        <g id="ic_fluent_arrow_enter_24_filled" fill="#fff" fillRule="nonzero">
